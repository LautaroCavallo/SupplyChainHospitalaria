      ...
      schemas: {
        ...
        RecetaValidacion: {
          ...
          properties: {
            ...
            alertas: { type: 'array', items: { type: 'string' }, description: 'Alertas clínicas no bloqueantes (incluye alergias); requieren confirmación explícita para dispensar' },
            alergias: { type: 'array', items: { type: 'string' }, description: 'Alérgenos del paciente detectados por HCE (subconjunto de "alertas")' },
        ...
        RecetaConsumoRequest: {
          ...
          properties: {
            ...
            confirmarAlertas: { type: 'boolean', description: 'Debe ser true si la receta tiene alertas clínicas y se desea dispensar de todas formas' },
          },
          required: ['items'],
        },
